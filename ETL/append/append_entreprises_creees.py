...
nom_fichier = "./Entreprises-crées/entreprises-immatriculees-en-2023.csv"
df = pd.read_csv(nom_fichier, sep=";")

# Appeler l'API et obtenir les données (les 100 premiers résultats)
api_url = "https://opendata.datainfogreffe.fr/api/explore/v2.1/catalog/datasets/entreprises-immatriculees-en-2023/records?select=*&order_by=date_de_publication&limit=5"
...
for result in data_api["results"]:
    nouvelles_donnees = {
        ...
        # "Geolocalisation": f"({result['geolocalisation']['lon']}, {result['geolocalisation']['lat']})",
...
print("Fichier des entreprises créées en CSV mis à jour avec succès !")
